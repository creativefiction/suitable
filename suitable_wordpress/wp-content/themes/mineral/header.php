	...
	<div  class="page-wrapper" >
		...
		<div id="header">
			<div class="section-boxed section-header">
				<div class="signin_cart_links">
					<a>SignIn</a>|<a>Cart()</a> <!-- Getting this shopify link integrated will be interesting
					 probably the best way to do it would be if I can insert a snippet of code that just brings the user to the shopify site.
					 in order to actually display the number of items in the cart,I would need to make a call to the api in php on this page that gets the amount. -->
				</div>
